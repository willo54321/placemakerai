...
// Test build of the marketing homepage, served at /testpage on the marketing
// domain while the design is iterated. Not indexed; the holding page remains
// the public front door until this is promoted.
export const metadata: Metadata = {
  title: 'Placemaker — homepage test build',
  description:
