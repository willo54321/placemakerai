...
// Confirm-button flow rather than unsubscribe-on-load: link scanners and
// mail-client prefetchers follow GET links, and they must not be able to
// silently unsubscribe people. One-click unsubscribes (RFC 8058) POST straight
// to /api/unsubscribe instead.
