...
/**
 * Flexible breakdown of all feedback, sliced by a chosen dimension (plot,
 * source channel, or map shape). Dimensions with fewer than two segments are
 * hidden; if none qualify (e.g. a single-source project) it renders nothing.
 */
  ...
  return (
    <div>
      ...
      <p className="text-sm text-slate-500 mb-4">
        The same feedback, sliced {active.label.toLowerCase()} — see where support and objection concentrate.
      </p>
